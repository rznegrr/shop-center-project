  ...
  return (
    <>
      <div>
        <img
          src={image}
          className="h-52 w-60 md:w-72 md:h-60 rounded-2xl"
          alt="blogs"
        />
      </div>
      <div className="absolute top-36 md:top-40 right-6 bg-white shadow-md w-48 md:w-60 md:h-36 p-3 md:p-5 rounded-xl overflow-hidden transform transition-transform duration-300 ease-in-out translate-y-0 hover:-translate-y-16">
